    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makePost.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Post post = new Post(new ArrayList<User>(), new User(FirebaseAuth.getInstance().getCurrentUser().getEmail(), FirebaseAuth.getInstance().getCurrentUser().getUid()), title, maxPrice, description, numOfDays, new Bid(INITIAL_BID_PRICE, INITIAL_DESCRIPTION, INITIAL_IMAGE, null), imageEncoding, category, condition, Long.toString(System.nanoTime()), date, false);
